...
# Get the directory where this script is located (Predictor folder)
...
def load_motifs(file_path=None):
    if file_path is None:
        # Look for protein_motifs.txt in the same directory as this script (Predictor folder)
        file_path = os.path.join(SCRIPT_DIR, 'protein_motifs.txt')
